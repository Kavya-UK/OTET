...
export default function OurProcess() {
  return (
    <div className="grid grid-cols-4 px-[15px] sm:px-[25px] lg:px-[40px] pt-[40px] pb-[60px] border-b-[2px] mb-[30px]">
      <div className="col-span-4 lg:col-span-1 flex justify-center items-center lg:block">
        <h1 className="text-[36px] xl:text-[44px] font-BasicSansBold text-codGray font-bold tracking-[9.72px] mb-[20px] ">
          Our Process
        </h1>
        <img
      ...
      <div className="col-span-4 lg:col-span-3 mt-[40px] lg:mt-[80px]">
        ...
        <p className=" font-BasicSans text-[14px] sm:text-[16px] xl:text-[20px] text-eastBay mt-[8px] lg:text-left text-center">
