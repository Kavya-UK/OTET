...
export default function Header({ setDropShadow = false }) {
 ...
 px-[0px] pt-[0px] text-left text-[0.75rem] leading-[1rem]  focus:outline-none font-bold z-40 "
        ...
        <div
          className={`md:hidden px-[1.5rem] text-darkBlack grid grid-col-12 py-[0.25rem]  bg-white h-[7rem] relative false ${
            setDropShadow ? " drop-shadow-md " : " "
          } z-20`}
        >
          <div className="flex flex-row justify-between items-center mx-5  text-gray-900 ">
            ...
            <div className="flex items-center justify-between">
              {/* <div className=" font-BasicSans font-bold lg:text-base text-[0.75rem] leading-[1rem]  tracking-[.15rem] cursor-pointer">
                <img
